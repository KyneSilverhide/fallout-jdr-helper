import {BOOK_ARMES_MUNITIONS_IT} from "./book-armes-munitions";
import {BOOK_GORGES_PENES_IT} from "./book-gorges-peness";
import {BOOK_GROGNAK_IT} from "./book-grognak";
import {BOOK_SURVIE_TERRES_DESOLEE_IT} from "./book-survie-terres-desolees";
import {BOOK_DORMIR_DEBOUT_IT} from "./book-dormir-debout";
import {BOOK_HOMMES_BOIS_IT} from "./book-homme-bois";
import {BOOK_INCREVABLE_IT} from "./book-increvables";
import {BOOK_MANUEL_ARMEE_USA_IT} from "./book-manuel-armee-usa";
import {BOOK_SCIENCE_TESLA_IT} from "./book-science-tesla";
import {BOOK_VIE_AMOUR_IT} from "./book-vie-amour";
import {BookType} from "../book-lang";

export const BOOK_TABLE_INDEX_IT: BookType[] = [
  {
    "Dice": 1,
    "Loot": "¡La Fantoma!",
  ...
  },
  {
    ...
    "Data": BOOK_GROGNAK_IT,
    "Description": "Depending on the individual issue found, you receive a different perk, which you may benefit from once. If you later learn the perk, you may use that benefit once per scene. Roll to determine the issue found."
  },
  {
    "Dice": 9,
    "Loot": "Guns and Bullets",
    "Data": BOOK_ARMES_MUNITIONS_IT,
    "Description": "Depending on the individual issue found, you receive a different perk, which you may benefit from once. If you later learn the perk, you may use that benefit once per scene. Roll to determine the issue found."
  },
  {
    "Dice": 10,
    "Loot": "Live & Love",
    "Data": BOOK_VIE_AMOUR_IT,
  ...
  },
  {
    "Dice": 17,
    "Loot": "Tumblers Today",
    "Data": BOOK_GORGES_PENES_IT,
    "Description": "Depending on the individual issue found, you receive a different perk, which you may benefit from once. If you later learn the perk, you may use that benefit once per scene. Roll to determine the issue found."
  },
  {
    "Dice": 18,
    "Loot": "Unstoppables",
    "Data": BOOK_INCREVABLE_IT,
  ...
  },
  {
    ...
    "Data": BOOK_MANUEL_ARMEE_USA_IT,
    "Description": "Depending on the individual issue found, you receive a different perk, which you may benefit from once. If you later learn the perk, you may use that benefit once per scene. Roll to determine the issue found."
  },
  {
    "Dice": 20,
    "Loot": "Wasteland Survival Guide",
    "Data": BOOK_SURVIE_TERRES_DESOLEE_IT,
    "Description": "Depending on the individual issue found, you receive a different perk, which you may benefit from once. If you later learn the perk, you may use that benefit once per scene. Roll to determine the issue found."
  }
];
